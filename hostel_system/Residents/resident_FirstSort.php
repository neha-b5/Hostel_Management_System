...
</style><link href="../new_style.css" rel="stylesheet" type="text/css">
</head>

<body>
<!-- Hyperlink for going back to home and Adding new Resident-->
<p>
<a href="new_resident.html">Add New Resident</a>
<a href="../Residents/resident_FirstSort.php">Sort by First Name</a>
...
if (isset($_POST['search'])){
    ...
    $result = $conn->query($sql);
        ...
        $sql = "SELECT * FROM resident_list order by FirstName";
        $result = $conn->query($sql);
    }
