...
if (isset($_POST['search'])){
    ...
    $sql = "SELECT ID, FirstName, LastName, Age, Mobile FROM staff_list where FIRSTNAME LIKE '%$search%' OR LASTNAME LIKE '%$search%'";
    $result = $conn->query($sql);
    }
    else{
        $sql = "SELECT ID, FirstName, LastName, Age, Mobile FROM staff_list order by FirstName"; //Show the table of the database by ording it by firstname
        $result = $conn->query($sql);
    }
